...
export interface ApiCursoCurso extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    capacidadCurso: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    creditosCurso: Schema.Attribute.Integer;
    descripcionCurso: Schema.Attribute.String;
    fechaFinCurso: Schema.Attribute.Date;
    fechaInicioCurso: Schema.Attribute.Date;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    >;
    nombreCurso: Schema.Attribute.String;
    periodoCurso: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiEstudianteEstudiante extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    fechaNacimientoEstudiante: Schema.Attribute.Date;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    matriculas: Schema.Attribute.Relation<
      ...
      'api::matricula.matricula'
    >;
    nombreEstudiante: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    telefonoEstudiante: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
